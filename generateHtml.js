/* this is file is static template used to
 show important view for user that have slow connection then show other data */
...
import LoadingDotsIcon from "./app/components/public/Loading";
import { StaticRouter as Router } from "react-router-dom";
import { StateContext } from "./app/store/global/ContextStore.js";

/*
 * this component will show only data that's important to show for the user when it's connection is slow.
 *
 */
function Shell() {
  return (
    <StateContext.Provider value={{ loggedIn: false }}>
      <Router>
        {/* staticEmpty --> we pass it to header component to hide some of data when loading */}
...
function html(x) {
  ...
  <html lang="en">
    <head>
      ...
      <link rel="shortcut icon" id="icon"href="https://lh3.googleusercontent.com/Zw2GEfEad4kQ-ILZpmB7Z36NSV_vQPlnV7dG9QL4CCzsk_podpHQI8j1frgRpyzBqog" />
...
*/
const fileName = "./app/index-template.html"; // create file name
const stream = fs.createWriteStream(fileName); // put this file in it's pass
stream.once("open", () => {
